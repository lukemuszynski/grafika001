...
{ 
    public static class SutherlandHodgman
    {
        ...
        {
            Point direction1 = line1To.Substract(line1From);
            Point direction2 = line2To.Substract(line2From);
            ...
            Point c = line2From.Substract(line1From);
            ...
            return line1From.Add(direction1.Multiply(t));
        }
        ...
        {
            Point tmp1 = edge.To.Substract(edge.From);
            Point tmp2 = test.Substract(edge.To);
